...
const HELP =
  "Send the title of a movie or series to see legal viewing options and a trailer.\n\n" +
  "Use Watchlist to save a title, or Recent searches to revisit the last 100 queries.";
